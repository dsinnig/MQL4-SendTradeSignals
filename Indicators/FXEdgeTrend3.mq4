                ...
                const int &spread[])
  {
   if (prev_calculated == 0) {
         for (int i = 0; i<rates_total; ++i) {
            double trend = iCustom(NULL, 0, "FXEdgeTrend_noDraw_3", 0, i);
            double barsSinceTrendChange = iCustom(NULL, 0, "FXEdgeTrend_noDraw_3", 1, i);
   ...
   if (prev_calculated != rates_total) {
      double trend = iCustom(NULL, 0, "FXEdgeTrend_noDraw_3", 0, 0);
      double barsSinceTrendChange = iCustom(NULL, 0, "FXEdgeTrend_noDraw_3", 1, 0);
      double priceSinceTrendChange = iCustom(NULL, 0, "FXEdgeTrend_noDraw_3", 2, 0);
      if (trend == -1.0) {
